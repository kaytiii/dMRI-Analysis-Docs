...
%%--------------------------------------------------------------------------------
%
%Process Histogram Script
%
% Creator of Original Script: Ali Tabesh
%Edited: 1/14/15 by Cliff C. for Comments & Formatting
%Edited: 2/16/18 by Corinne McGill
%Edited: 11/12/20 by Kayti Keith
%
%----------------------------------------------------------------------------------

%% Folder Paths

base_folder = '/Path/to/study/04_Summary/';
roi_folder= '/Path/to/study/03_Analysis/02_Warped_Segments/';
roi_QC_folder = '/Path/to/study/03_Analysis/';
map_folder = '/Path/to/study/02_Cases/02_DKE_Maps/';
    ...
    for j = 1:length(map_str_list)
        ...
        mkdir(output_folder)
            ...
            for i = 1:length(id_list)
                ...
                fn_mask_roi = fullfile(roi_folder, id_list{i}, [id_list{i} '_' roi_list{k} '.nii']);     
                ...
                fn_map = fullfile(img_folder, [id_list{i}, '_', map_str_list{j} '.nii']);                    
